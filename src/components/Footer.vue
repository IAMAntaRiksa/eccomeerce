        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 mb-4">
                    ...
                    <p>
                        Toko Online Shopping/Store Terpercaya di
                        Indonesia. Jual Beli Aman & Harga Termurah! Belanja
                        sekarang.
                    </p>
                    <div class="social">
                        <a href="#" class="mr-4"> <i class="fab fa-facebook fa-2x"></i></a>
                        <a href="#" class="mr-4" style="color:#00c4ff">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <hr style="border-top: 3px solid rgb(226 232 240);border-radius:.5rem">
                    <p>
                        <i class="fa fa-clock"></i> Toko Buka Setiap
                        Hari :
                        <br>
                        Senin - Minggu ( 07.00 s/d 16.00 )
                    </p>
                    <p>
                        <i class="fa fa-map-marker"></i> Desa Gedang
                        Alas, RT/RW : 008/002, Kecamatan Gajah, Kabupaten
            ...
            <div class="row text-center mt-3 pb-3">
                <div class="col-md-12">
                    <hr>
                    © <strong>Online Shop</strong> 2020 • Hak Cipta
                    Dilindungi
                </div>
            </div>
        </div>
