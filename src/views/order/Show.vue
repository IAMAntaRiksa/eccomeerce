        ...
        <div class="row">
            ...
            <div class="col-md-9 mb-4">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button @click="payment(detailOrder.snap_token)"
                                        v-if="detailOrder.status == 'pending'" class="btn btn-primary">
                                        BAYAR SEKARANG
                                    </button>
                ...
                border-color: rgb(198, 206, 214) !important; ">
                            <tbody>
                                <tr v-for="product in detailOrder.orders" :key="product.id" style="background: #edf2f7">
...
export default defineComponent({
    ...
    setup() {
        ...
        onMounted(() => {
            store.getDetailOrder(router.params.snap_token)
        })
